...
export default function LongzihuCenterPage() {
  return (
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium text-red-600">45mm/h (大暴雨)</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-1">
                    ...
                    <span className="font-medium text-red-600">4.2m (超警戒线)</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-1">
                    ...
                    <span className="text-sm">5分钟前</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-1">
                ...
                <div className="space-y-3">
                  <div className="p-3 bg-red-50 border border-red-200 rounded-md">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="font-medium text-red-800">暴雨红色预警</span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <div className="mt-2 h-[100px] w-full bg-gradient-to-b from-white to-blue-500 rounded-md relative">
                          ...
                          <div className="absolute left-0 right-0 border-t-2 border-blue-700" style={{ top: "20%" }}>
                            <div className="absolute -top-3 left-0 text-xs text-blue-700 bg-white px-1">当前: 4.2m</div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="flex items-end gap-2">
                          <div className="text-3xl font-bold">45mm/h</div>
                        ...
                        <div className="mt-2 h-[100px] w-full bg-gradient-to-r from-blue-100 via-blue-300 to-blue-600 rounded-md relative">
                          <div className="absolute inset-x-0 bottom-0 h-[80%] bg-blue-400 bg-opacity-50 rounded-b-md"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 pt-4 border-t">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      ...
                      <div className="p-3 bg-gray-50 rounded-md">
                        ...
                        <div className="text-lg font-medium">4级</div>
                      </div>
                      <div className="p-3 bg-gray-50 rounded-md">
                        <div className="text-sm text-muted-foreground">气压</div>
                        <div className="text-lg font-medium">1005hPa</div>
                      </div>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div className="h-[200px] w-full bg-white rounded-md relative mb-4">
                    <div className="absolute inset-0 flex flex-col">
                      ...
                      <div className="flex-1 border-b border-l relative">
                        <div className="absolute bottom-0 left-0 right-0 h-[80%] bg-gradient-to-r from-blue-100 to-blue-400 opacity-20"></div>
                        <div
                        ...
                        <div className="absolute top-0 left-0 right-0 flex justify-between px-2">
                          ...
                          <span className="text-xs">预计未来6小时降水量将达100-150毫米</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <CardContent>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-3 bg-gray-50 rounded-md">
                      ...
                      <div className="text-lg font-bold">4.5m</div>
                      <div className="text-xs text-muted-foreground">记录于 2023年7月22日</div>
                    </div>
                    <div className="p-3 bg-gray-50 rounded-md">
                      <div className="text-sm font-medium mb-1">历史最大降雨量</div>
                      <div className="text-lg font-bold">52mm/h</div>
                      <div className="text-xs text-muted-foreground">记录于 2023年7月21日</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
